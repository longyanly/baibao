...
const itemData = [
    ...
    },
    {
        ...
        tech: '炼金引擎（二本）',
        features: [
            '沃姆伍德模样的种田助手：在[[星塔]]范围内自动农活，不跟随玩家',
            '开荒 / 锄地 / 清杂物 / 播种 / 收获 / 浇水 / 施肥 / 对话照料；可捡圈内掉落并存入[[万物百宝]]、[[百宝小型]]或[[白熊冰箱]]',
            '20 格背包（5×4），无限堆叠，格内物品暂停腐烂；打开背包时可管理手 / 身 / 头装备栏',
            '给予[[封印之杖]]、[[封印之杖2]]、锄头、铲子等后会装备使用；法杖走真实法术（收集 / 开垦 / 浇水 / 施肥 / 对话）',
            '缺物资时头顶语音提示；须先放置[[星塔]]并让其连上工作圈'
        ],
        hasDetail: true
    },
    {
