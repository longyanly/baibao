...
const itemData = [
    ...
    },
    {
        ...
        image: 'img/tc_chest.png',
        category: 'architecture',
        recipe: '[[月食遗物]] × 1 + [[太阳火种]] × 1 + 金块 × 25',
        tech: '太阳雕像科技（需要[[太阳雕像仿品]]作为科技站）',
        features: [
            '游戏内名称「万物百宝小型」：紧凑面板，适合不习惯[[万物百宝]]大块 UI 的玩家',
            '左侧主收纳 45 格，支持无限堆叠；右上单格为科技钥物（解锁规则与万物百宝右上角一致）',
            '右下格：放入橙宝石且「控制」开启时可全图自动收集；可切换收集间隔（如 30 秒、1 游戏日）',
            '整理左侧 45 格；保鲜模式与万物百宝共用模组配置（含月圆批量回鲜等）',
            '无万物百宝的多宝石扩展（绿/黄/蓝/紫等种田与秒杀亮茄格）',
            '月圆夜宝石掉落等机制：左侧 45 格需全部为金块时按间隔在夜晚触发（详见详情）',
            '不可拆解'
        ],
        hasDetail: true
    },
    ...
    },
    {
        id: 'zhei_farm_zone',
        name: '星塔',
        image: 'img/zhei_farm_zone.png',
        category: 'architecture',
        recipe: '[[星星碎片]] × 2 + 电子元件 × 1 + 紫宝石 × 1',
        tech: '炼金引擎（二本）',
        features: [
            '标出[[百宝种地的神]]的工作范围；放置时可预览工作圈（半径可在模组配置中调整，默认 16 码）',
            '内置 3×4（12 格）转化容器，支持无限堆叠；放入原料后点「转化」批量处理',
            '转化示例：蝴蝶翅膀→黄油(3:1)、蜂刺→蜂蜜(3:1)、蜂蜜→羊奶(2:1)、木头→木炭(1:1/3 秒)、肉→鸟蛋、作物→种子(鸟笼规则)、猪王可收物品→金块等',
            '有耐久物品可整批耐久归零（整批固定 8 分钟）；仅木头→木炭时固定 3 秒',
            '一座星塔同时仅绑定一名种地神；右键星塔可解除绑定'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_baibao_farm_god',
        name: '百宝种地的神',
        image: 'img/zhei_baibao_farm_god.png',
        category: 'architecture',
        recipe: '活木 × 3 + 种子 × 5 + 齿轮 × 2',
        tech: '炼金引擎（二本）',
        features: [
            '沃姆伍德模样的种田助手：在[[星塔]]范围内自动干活，不跟着你跑',
            '开荒、清杂物、按九格种子播种、收获、浇水、施肥、对话照料；收获可存入圈内[[万物百宝]]、[[百宝小型]]或[[白熊冰箱]]',
            '背包 5×5（25 格），左上 3×3 专放种子，其余格只放收获物；无限堆叠，格内暂停腐烂',
            '打开背包可点「分配」均分九格种子，并管理手 / 身 / 头装备；给[[封印之杖]]、[[封印之杖2]]、铲子等会自动装备使用',
            '自身储水仅由[[好运池]]补充（容量 18000）；无[[封印之杖2]]时用储水浇地',
            '缺东西会头顶说话提醒；须先放[[星塔]]并连上工作圈；可用[[种地神遥控器]]指挥休息或按配比摆种'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_wa_remote',
        name: '种地神遥控器',
        image: 'img/zhei_wa_remote.png',
        category: 'tools',
        recipe: '种子 × 5 + 电子元件 × 1 + 金块 × 2',
        tech: '炼金引擎（二本）',
        features: [
            '薇诺娜同款遥控轮盘：手持打开后可指挥[[百宝种地的神]]',
            '「休息」：范围内的种地神原地躺下，暂停农活并加快回血（读档后仍保持休息）',
            '「开始工作」：叫醒种地神，继续自动农活',
            '「种植配比」：读取星塔圈内冰箱种子，列出可巨大化的摆种方案，点选后种地神自动清格、取种、摆九格并开种',
            '指挥范围可在模组配置中调整（默认玩家附近 48 码；可改为全图）'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_good_luck',
        name: '好运池',
        image: 'img/zhei_good_luck.png',
        category: 'architecture',
        recipe: '石砖 × 5 + 黄金铲 × 1 + [[星星碎片]] × 10',
        tech: '太阳雕像科技（需要[[太阳雕像仿品]]作为科技站）',
        features: [
            '可泡澡温泉：最多 4 人同泡；默认约血 +5/秒、san +2.5/秒，并缓慢解除生命上限惩罚（黑血）；速率可在模组配置中调整',
            '冬暖夏凉：旁站与泡澡均有季节体温效果；泡澡积攒的体温 buff 离池后仍可持续（上限约 40 分钟）',
            '可打水；背起疙瘩树果可种入水中木（每池一棵）；泡澡时影怪不会主动攻击',
            '旁放[[好运石]]后：可作祟复活（冷却 1 分钟、无次数限制）；石内灵药供泡澡吸取、活鱼在池面游动',
            '范围内可为[[百宝种地的神]]自动补水（储水唯一来源）；永久建筑，不可锤毁',
            '泡澡有概率掉落[[真好运石]]（进池立刻判一次，之后每 30 秒；每位玩家独立 1%）'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_good_luck_stone',
        name: '好运石',
        image: 'img/zhei_good_luck_stone.png',
        category: 'container',
        recipe: '告密的心 × 1 + [[星星碎片]] × 5 + 重生护符 × 2',
        tech: '太阳雕像科技（需要[[太阳雕像仿品]]作为科技站）',
        features: [
            '只能安放在[[好运池]]旁环带内（距池中心约 4.7～5.7 码）；一池一石',
            '3×4（12 格）容器：仅可放入三种浸泡灵药与活鱼（池塘鱼 / 小型海洋生物）',
            '绑定后：池子作祟复活无次数限制（冷却 1 分钟）；灵药供泡澡吸取对应 buff；活鱼在池面显示游动装饰',
            '反鲜速率与[[玉食盒]]共用模组配置「玉食盒/好运石反鲜速率」（默认 5%）',
            '可锤毁（工作量 3），拆除返还配方材料并掉出格内物品；有「好运石·彩纹」皮肤'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_good_luck_stone_z',
        name: '真好运石',
        image: 'img/zhei_good_luck_stone_z.png',
        category: 'materials',
        recipe: '泡澡掉落：在[[好运池]]中浸泡时随机获得（不可制作）',
        tech: '不可制作',
        features: [
            '可携带幸运结晶；每位玩家身上最多一颗（再捡会自动丢回地上）',
            '手持右键吸收小偷包或[[紫水晶剑]]获取经验：每级 25 经验，最高 10 级',
            '幸运掉落：1 级 +3% … 10 级 +30%（概率物判定下限）',
            'Boss / 坎普斯 / 海象掉落倍率：1 级 ×1、2–4 级 ×2、5–9 级 ×3、10 级 ×4',
            '豆增压式护盾：受击有概率完全格挡（1 级 5% … 10 级 50%）'
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        ...
        features: [
            ...
            '收集按钮：打开界面后点击「收集」，全图扫描并吸入展示柜内已有同类 prefab（与小型百宝手动收集逻辑一致）',
            '整理按钮：打开界面后点击「整理」，按万物百宝同款规则排序合并',
    ...
    },
    {
        ...
        category: 'tools',
        recipe: '[[星星粉尘]] × 10 + [[熊猫棕子]] × 8 + 蓝宝石 × 2',
        tech: '炼金引擎（[[星澜]]一级可制作）',
        features: [
            '星澜专属锅：研磨、烹饪、调味三合一；部署后队友可用',
            '棱镜特色：无视月圆做月相四件套（月饼/月酿=白天，花儿粑/花儿酒=黑夜）',
            '双成品位、大容量储物；收回再部署保留进度与内容',
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        id: 'zhei_zfantong',
        name: '真饭桶',
        image: 'img/zhei_zfantong.png',
        category: 'architecture',
        recipe: '石砖 × 15 + 电子元件 × 10 + 荧光果 × 8 + [[饭桶]] × 1',
        tech: '暗影操控器（四本）',
        features: [
            '落地烹饪站：右键「打开」进入书本式 UI，从联动冰箱取料并抛物送入附近空锅（不消耗理智，无需手持[[饭桶]]施法）',
            '联动半径：默认 12 世界单位（模组配置），识别冰箱/盐盒、扣料校验、搜索空锅三者一致；悬停显示约合格数',
            '贴身操作：打开界面与点「烹饪」须靠近本体约 1 格；走远会自动关界面并释放占用',
            '「烹饪」页：浏览附近容器食材，三排四格预设（可锁定/选用），选锅型后预测并下锅；空锅与食材足够时可一次入多口锅',
            '料理书签：原版锅 / 大厨锅 / 百宝料理 / 模组料理等，点某道菜可自动选料下锅（优先较便宜的同类食材）',
            '口渴 mod：启用且已注册煮饮站配方时，额外显示「煮饮 / 酿酒 / 蒸馏」书签（仅查阅配方，不能自动下锅）',
            '锅型档位：普通烹饪锅 / 大厨便携锅（须大厨标签）/ [[百宝炊具]]；预测与入锅逻辑与对应配方表一致',
            '独占使用：同一时间仅一名玩家占用；他人提示「队友使用中」',
            '锤击可拆除（有工作量）'
        ],
        hasDetail: true
    },
    ...
    },
    {
        ...
        tech: '远古科技',
        features: [
            '制作产出为迁移打包纸（zhei_superpack_wrap，与下方「包裹」zhei_superpack 不同）',
            '超级打包：手持打包纸右键目标建筑/物品，产出对应「xxx包裹」并可栽种部署',
            '默认可打包：[[万物百宝]]、[[百宝小型]]、[[月食雕像仿品]]；模组配置可放宽为更多物品',
            '每次迁移消耗 1 张打包纸；手持[[混沌水晶]]可对打包纸变异为[[百宝迁移装置·混沌]]'
        ]
    },
    {
        id: 'zhei_superpack_wrap_chaos',
        name: '百宝迁移装置·混沌',
        image: 'img/zhei_superpack_wrap.png',
        category: 'tools',
        recipe: '百宝迁移打包纸（zhei_superpack_wrap）× 1 + [[混沌水晶]] × 1（手持水晶对打包纸右键「混沌迁移」；叠多张也只变 1 张）',
        tech: '无',
        features: [
            '由远古科技制作的百宝迁移打包纸经[[混沌水晶]]变异；外观与普通纸相同，带 zhei_superpack_wrap_chaos 标签',
            '手持打包纸右键场景/物品栏内可迁移目标 → 动作「迁移」；成功产出「xxx包裹」（zhei_superpack），混沌版不消耗自身',
            '默认可迁移：[[万物百宝]]、[[百宝小型]]、[[月食雕像仿品]]；模组配置「百宝迁移装置允许打包所有物品」可放宽范围',
            '包裹可栽种部署还原建筑；支持传送门配对保留、无 placer 时用动态放置器预览',
            '不可堆叠；不沉水；可作中等燃料；不可再被混沌水晶处理'
        ],
        hasDetail: true
    },
    {
        id: 'tc_baibao_giftwrap',
        name: '百宝包装',
        image: 'img/giftwrap.png',
        category: 'tools',
        recipe: '莎草纸 × 1 + 花瓣 × 1 → 一次 4 张',
        tech: '炼金引擎（二本）',
        features: [
            '打包工具：右键打开 4×4 打包界面（原版节日礼物包装为 2×2）',
            '每次成功打包消耗 1 张包装纸，产出「百宝礼物」（tc_baibao_gift）',
            '礼物盒悬停可查看完整内容（百宝悬停系统；兼容 Show Me / Insight）',
            '不可打包：不可替代、容器类、已是 bundle、带 nobundling 标签的物品',
            '可堆叠；可作燃料；手持[[混沌水晶]]可变异为[[百宝包装·混沌]]'
        ],
        hasDetail: true
    },
    {
        id: 'tc_baibao_giftwrap_chaos',
        name: '百宝包装·混沌',
        image: 'img/giftwrap.png',
        category: 'tools',
        recipe: '[[百宝包装]] × 1 + [[混沌水晶]] × 1（对物品栏中的百宝包装右键使用，消耗水晶；叠多张也只变 1 张）',
        tech: '无',
        features: [
            '由[[百宝包装]]经[[混沌水晶]]变异；变异后不可再堆叠',
            '打包界面仍为 4×4，但格内支持无限堆叠',
            '每次打包不消耗自身，可反复使用（普通版每包消耗 1 张）',
            '产出仍为百宝礼物；悬停与内容预览同普通版'
        ],
        hasDetail: true
    },
    {
        id: 'tc_baibao_broom',
        name: '百宝扫把',
        image: 'img/reskin_tool.png',
        category: 'tools',
        recipe: '清洁扫把 × 1 + 花瓣 × 4 + 绳子 × 1',
        tech: '炼金引擎（二本）',
        features: [
            '批量换肤：装备后对目标左/右键换皮肤，对地面施法可批量打扫半径 4 内建筑（操作对齐棱镜敝帚之珍）',
            '四种主模式：顺序 / 逆序 / 随机 / 复制粘贴（已装备时在物品栏右键「切换」；悬停显示当前模式与已复制皮肤）',
            '左键与右键可绑定不同子模式；复制模式下右键复制、左键粘贴同类建筑',
            '支持原版清洁扫把可换肤目标及百宝建筑（[[万物百宝]]、[[百宝小型]]、[[百宝炊具]]、[[百宝背包]]等）；须拥有对应皮肤',
            '可作中等燃料；模式与复制信息会存档'
        ],
        hasDetail: true
    },
    {
        id: 'zhei_baibao_detector_item',
        name: '百宝探测器',
        image: 'img/zhei_baibao_detector.png',
        category: 'tools',
        recipe: '石头 × 5 + 电子元件 × 2 + [[星星碎片]] × 1',
        tech: '炼金引擎（二本）',
        features: [
            '放置扫描：部署后约 5 秒全图感应，同时指示多个目标并在地面生成彩色箭头（持续 30 秒）',
            '探测目标：流浪商人（含剧情隐藏时）、[[太阳雕像珍品]]、[[月食雕像珍品]]、掉落在地下的艾力冈之剑',
            '光束指向最近目标；箭头颜色：商人白 / 太阳橙 / 月食紫 / 艾力冈剑红',
            '耐久 10 次；未找到目标也会消耗 1 次；空闲时可收起重置为物品；锤击可拆除返还材料'
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        ...
        tech: '无',
        features: [
            '由园艺学简编使用[[混沌水晶]]变异获得；耐久 15 次',
            '催生农田作物时不影响巨大化，范围内无数量限制（每读一轮各推进一阶段）',
            '可催生水中木（疙瘩树）、起源模组琉璃树结果',
            '安装<b>神话书说</b>时：可催生神话桃树；封印完毕的复苏仙树读书一次长成人参果树；大人参果树读书结一枚人参果'
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        ...
        category: 'cuisine',
        recipe: '甜味剂 × 1 + 同种浆果 × 2（普通浆果/多汁浆果，生或熟均可，不可混搭）+ 胡萝卜 × 1（生或熟，不可含肉类）',
        buff: '素食Buff',
        attributes: '+60血 / +75饱食 / +33San',
        features: ['食物类型：好东西', '保鲜时间：15天', '烹饪时间：2分钟', '典型配方：蜂蜜 × 1 + 浆果 × 2 + 胡萝卜 × 1', '素食buff（仅对薇格弗德和妥协的角色Wathom生效）', '持续时间：25分钟', '效果：允许薇格弗德和Wathom食用素食', '备注：龙炎的最爱']
    },
    {
    ...
    // ====================================================================
    {
        ...
        category: 'elixirs',
        recipe: '[[百宝鼎]]炼制：相思断肠红精华 ×3 → 2 份',
        tech: '百宝鼎',
        buff: '名刀司命',
        attributes: '食用：自身 +10 生命（见详细介绍）',
        features: [
            '由[[百宝鼎]]炼制：精华 ×3 炼出 2 份，炼制约 4 分钟；精华为 3 的倍数时可一次多份（6→4、9→6…）',
    ...
    },
    {
        ...
        category: 'elixirs',
        recipe: '[[百宝鼎]]炼制：烈火杏娇疏精华 ×3 → 2 份',
        tech: '百宝鼎',
        buff: '火免抗性',
        features: [
            '由[[百宝鼎]]炼制：精华 ×3 炼出 2 份，炼制约 4 分钟；精华为 3 的倍数时可一次多份（6→4、9→6…）',
            'Buff作用：持续 2 天——火焰免疫、免疫火焰伤害和过热，大力士肌肉不掉；命中敌人额外 +20 位面真伤',
            '可放入[[好运石]]，在[[好运池]]泡澡时吸取积累相同火免抗性 buff'
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        ...
        category: 'elixirs',
        recipe: '[[百宝鼎]]炼制：鸡冠凤凰葵精华 ×3 → 2 份',
        tech: '百宝鼎',
        buff: '熬夜大师',
        features: [
            '由[[百宝鼎]]炼制：精华 ×3 炼出 2 份，炼制约 4 分钟；精华为 3 的倍数时可一次多份（6→4、9→6…）',
            'Buff作用：持续 1 天——昏睡值抗性 + 免疫；攻击时召唤与启迪之冠同类月灵，每次攻击扣 1 理智',
            '可放入[[好运石]]，在[[好运池]]泡澡时吸取积累相同熬夜大师 buff'
        ],
        hasDetail: true
    },
    ...
    // ====================================================================
    {
        ...
        category: 'materials',
        recipe: '[[百宝鼎]]炼制：[[相思断肠红芽穗]] ×2 + [[相思断肠红花]] ×2',
        tech: '百宝鼎',
        features: [
            '检视：相思之力凝成的一滴精粹，温润却有韧性。',
            '炼制约 2 分钟/套；芽穗与花按套数成比例可一次炼多份；同种精华 ×3 可炼 [[相思断肠灵药]] ×2（约 4 分钟）',
        ],
        hasDetail: true
    },
    {
        ...
        category: 'materials',
        recipe: '[[百宝鼎]]炼制：[[八角玄冰芽穗]] ×2 + [[八角玄冰草花]] ×2',
        tech: '百宝鼎',
        features: [
            '检视：寒意被提炼得更纯粹，握久了指尖都发凉。',
            '炼制约 2 分钟/套；芽穗与花按套数成比例可一次炼多份；同种精华 ×3 可炼 [[八角玄冰灵药]] ×2（约 4 分钟）',
        ],
        hasDetail: true
    },
    {
        ...
        category: 'materials',
        recipe: '[[百宝鼎]]炼制：[[烈火杏娇疏芽穗]] ×2 + [[烈火杏娇疏花]] ×2',
        tech: '百宝鼎',
        features: [
            '检视：炽热药性被锁在其中，像一簇收束的火苗。',
            '炼制约 1 分 30 秒/套；芽穗与花按套数成比例可一次炼多份；同种精华 ×3 可炼 [[烈火杏娇疏灵药]] ×2（约 4 分钟）',
        ],
        hasDetail: true
    },
    {
        ...
        category: 'materials',
        recipe: '[[百宝鼎]]炼制：[[鸡冠凤凰葵芽穗]] ×2 + [[鸡冠凤凰葵花]] ×2',
        tech: '百宝鼎',
        features: [
            '检视：如同凤凰尾焰留下的精华，暖意轻盈却绵长。',
            '炼制约 1 分 10 秒/套；芽穗与花按套数成比例可一次炼多份；同种精华 ×3 可炼 [[鸡冠凤凰灵药]] ×2（约 4 分钟）',
        ],
        hasDetail: true
    },
    {
    ...
    },
    {
        ...
        category: 'materials',
        recipe: '星澜击杀或助攻 Boss 时概率额外掉落',
        tech: '星澜',
        features: [
            '定位：星澜专用成长道具，仅星澜食用时每颗 +50 经验',
            '掉落：击杀或助攻 epic/雕像 Boss 时按概率额外掉落（默认 30%，幸运可加成）',
    ...
    },
    {
        ...
        tech: '无',
        features: [
            '手持混沌水晶，对物品栏中目标右键使用；使用后消耗 1 颗，效果永久（已处理过的目标不可重复）',
            '【移除耐久】[[紫水晶剑]]、[[紫水晶刀]]；丰耘秘境「自然亲和子塔」「辉煌多用工具」→ 无限耐久',
            '【变异】月之魔典→[[月之魔典混沌]]；[[千机伞]]→[[千机伞混沌]]；园艺学简编→园艺学简编混沌；亮茄炸弹→[[亮茄炸弹混沌]]；[[羽扇]]→[[羽扇混沌]]',
            '【独立变异·须手持】[[百宝包装]]→[[百宝包装·混沌]]；百宝迁移打包纸→[[百宝迁移装置·混沌]]（叠多张也只变 1 张，混沌版不可再堆叠）',
            '【背包升级】[[百宝背包]]→混沌保鲜（保鲜倍率归零、食物暂停腐烂，不可重复升级）'
        ],
        hasDetail: true
    },
    {
