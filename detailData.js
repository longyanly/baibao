...
const detailData = {
    ...
    "zhei_baibao_farm_god": `
        <p><b>百宝种地的神</b>是万物百宝自带的自动种田助手，外形类似沃姆伍德。部署后会在[[星塔]]标出的工作圈内独立完成一整条农事流程——<b>不跟随玩家</b>，也不会被怪物选为攻击目标。</p>
        ...
        <ol>
            <li>先放置一座[[星塔]]圈定范围</li>
            <li>在附近部署百宝种地的神，稍等片刻会自动连上星塔</li>
            <li>把锄头、铲子、种子、水壶、肥料或法杖交给它，或丢在工作圈内地上让它自取</li>
            <li>圈内放置[[万物百宝]]、[[百宝小型]]或[[白熊冰箱]]，可作为种子库与收获存放点</li>
        </ol>

        <p><b>自动农活（工作圈内）：</b></p>
        <ul>
            <li><b>开荒：</b>未耕过的地皮会先锄地；有[[封印之杖]]时优先用法杖开垦法术（3×3 / 10 格等，与法杖一致）</li>
            <li><b>清杂：</b>用铲子或[[封印之杖]]清除农场杂物</li>
            <li><b>播种：</b>空坑自动种 seed；种子可来自背包、玩家给予、圈内地面，或从百宝 / 小型百宝 / 白熊冰箱取（取种时若容器正被玩家打开会语音提示请先关闭）</li>
            <li><b>收获：</b>成熟作物手摘；巨大作物可敲收；持[[封印之杖]]且圈内有多株待收时，会用<b>收集法术</b>批量处理</li>
            <li><b>照料：</b>对话、浇水、施肥——有[[封印之杖2]]时优先用法术（对话 / 浇水 / 施肥 AOE）；否则用物理水壶、肥料等</li>
            <li><b>拾取与存箱：</b>捡起圈内掉落物；背包满或有多余收获时存入工作圈内的百宝 / 冰箱</li>
            <li><b>脱困：</b>被针刺旋花缠住时会自行攻击脱困</li>
        </ul>

        <p><b>背包与装备：</b></p>
        <ul>
            <li><b>5×4（20 格）</b>背包，支持无限堆叠；格内物品<b>暂停腐烂</b></li>
            <li>打开背包时会出现<b>手 / 身 / 头</b>装备栏 UI，可像管理玩家一样给它换装备</li>
            <li>右键给予物品时会收进背包；可装备物（法杖、锄头、护甲等）会自动换到对应槽位</li>
            <li>装备[[封印之杖]] / [[封印之杖2]] 后，它会<b>真正施放法杖法术</b>（不是单纯模仿动画）</li>
        </ul>

        <p><b>法杖分工（推荐）：</b></p>
        <ul>
            <li><b>[[封印之杖]]：</b>收集（批量收作物 / 敲巨大作物）、开垦（3×3 等）</li>
            <li><b>[[封印之杖2]]：</b>对话照料、范围浇水、范围施肥；全部照料完成后有约 6 秒冷却</li>
            <li>无杖2 时，会用物理方式对话 / 浇水 / 施肥；缺工具或物资时头顶会有<b>语音提示</b>（如缺锄头、缺种子、水壶没水等）</li>
        </ul>

        <p><b>生存属性：</b></p>
        <ul>
            <li>生命上限 <b>300</b>，缓慢自愈；一般不会被怪物当作攻击目标</li>
            <li>可穿过巨大作物等障碍；不会溺水</li>
            <li>死亡时掉落背包物品</li>
        </ul>

        <p><b>与[[星塔]]的配合：</b></p>
        <ul>
            <li>工作半径与星塔圈一致，见模组配置<b>「百宝种地的神工作半径」</b>（默认 16 码）</li>
            <li>星塔被拆除或失效后，种地神会重新搜索附近的星塔</li>
            <li>星塔的十二格转化与种地神农活相互独立：转化在星塔格内操作，农活在工作圈地面进行</li>
        </ul>
    `
};
