...
const detailData = {
    ...
    "book_horticulture_chaos": `
        <p><b>园艺学简编混沌</b>是园艺学简编经[[混沌水晶]]变异后的混沌书籍。相比原版园艺学简编，催生时<b>不设数量上限</b>、<b>不阻止农田作物巨大化</b>，并额外支持水中木、起源琉璃树，以及与<b>神话书说</b>模组联动的人参果线。</p>
        
        <p><b>获取方式：</b></p>
        <ul>
            <li>手持[[混沌水晶]]，对物品栏中的<b>园艺学简编</b>使用，消耗 1 颗水晶变异为园艺学简编混沌</li>
            <li>耐久 <b>15 次</b>，用完消失；可作燃料</li>
        </ul>
        
        <p><b>通用催生规则：</b></p>
        <ul>
            <li>以读者为中心约 <b>30 格</b>范围内生效</li>
            <li>每<b>阅读一次</b> = 范围内所有可催生目标各<b>推进一阶段</b>；再读再进一阶段（不是一次读满）</li>
            <li>农田作物：不设「禁止巨大化」标记，水肥季节满足时仍可长成巨大作物</li>
            <li>阅读消耗大量理智（同原版园艺学简编）；范围内无可催生目标时会提示</li>
        </ul>

        <p><b>其它模组联动：</b></p>
        <ul>
            <li><b>水中木（疙瘩树）：</b>可催生 short / normal / tall 各阶段；海里尚未长出的水中木种子也可被立即催成幼树；树柱可催冠下藤蔓结无花果</li>
            <li><b>起源模组：</b>琉璃树只催<b>结果与掉枝</b>，不催生长阶段</li>
        </ul>

        <p><b>神话书说联动（须安装神话书说 mod）：</b></p>
        <ul>
            <li><b>神话桃树：</b>芽、苗、成树各可读书推进<b>一阶段</b>（成树走 growable，芽/苗跳过生长倒计时）</li>
            <li><b>复苏仙树：</b>须先用<b>日、月精华各一种</b>完成封印（两种精华均已投入）；此后在范围内<b>读书一次</b>即可直接长成<b>大人参果树</b></li>
            <li><b>大人参果树：</b>读书一次在树上<b>结一枚人参果</b>（遵守树上挂果数量上限；已满则无效）</li>
        </ul>
        <p><span style="color:#666;">未装神话书说时，上述桃树 / 复苏仙树 / 人参果树相关目标不存在，书籍仍可对普通作物、水中木等照常使用。</span></p>
    `,
    ...
    "zhei_liehuoyao": `
        ...
        <p><b>泡澡：</b>放入[[好运石]]后，在[[好运池]]泡澡可吸取本药积累相同火免抗性 buff（相思药除外）。</p>
    ...
    "zhei_xuanbinyao": `
        ...
        <p><b>泡澡：</b>放入[[好运石]]后，在[[好运池]]泡澡可吸取本药积累相同极致寒冰 buff。</p>
    ...
    "zhei_jiguanyao": `
        ...
        <p><b>泡澡：</b>放入[[好运石]]后，在[[好运池]]泡澡可吸取本药积累相同熬夜大师 buff。</p>
    ...
    "zhei_farm_zone": `
        <p><b>星塔</b>是标定[[百宝种地的神]]工作范围的建筑，同时自带十二格批量转化功能。以星辉为形，部署后在地上圈出一片固定半径的「工作区」——种地神只会在这片范围内自动干活，不会跟着玩家到处跑。</p>

        <p><b>制作配方：</b>[[星星碎片]] × 2 + 电子元件 × 1 + 紫宝石 × 1</p>
        <p><b>制作科技：</b>炼金引擎（二本）；百宝结构栏</p>

        <p><b>工作范围：</b></p>
        <ul>
            <li>放置时可预览绿色工作圈；半径由模组配置<b>「百宝种地的神工作半径」</b>决定，默认 <b>16 码</b></li>
            <li>[[百宝种地的神]]部署在附近后会自动连上最近的星塔；未连上时会提示「请在附近放一个星塔」</li>
            <li>同一座星塔<b>同时只服务一名</b>种地神（一对一绑定）</li>
            <li>星塔上已有绑定的种地神时，可对星塔<b>右键</b>执行「解除绑定」</li>
        </ul>

        <p><b>转化容器（3×4，共 12 格）：</b></p>
        <ul>
            <li>格内支持<b>无限堆叠</b>；放入可转化原料后，点界面下方<b>「转化」</b>开始批量处理</li>
            <li>转化进行中塔身会有动效与音效；转化期间不可改格内物品</li>
            <li>默认转化耗时可在模组配置<b>「星塔转化时间」</b>中调整（默认 <b>8 分钟</b>；选项「3 天」指 3 个游戏日）</li>
            <li><b>特例：</b>格内<b>仅有木头</b>时，木头→木炭固定 <b>3 秒</b>（1:1）；格内<b>任一有耐久物</b>参与转化时，<b>整批固定 8 分钟</b>（混放其它物品也不可缩短）</li>
        </ul>

        <p><b>支持的转化规则（摘要）：</b></p>
        <table style="border-collapse:collapse; width:100%; max-width:640px; margin:8px 0; font-size:0.95em;">
            <tr style="background:#f5f5f5;"><td style="border:1px solid #ccc; padding:6px;"><b>原料</b></td><td style="border:1px solid #ccc; padding:6px;"><b>产出</b></td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">蝴蝶翅膀</td><td style="border:1px solid #ccc; padding:6px;">黄油（3:1，不足 3 个不消耗）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">蜂刺</td><td style="border:1px solid #ccc; padding:6px;">蜂蜜（3:1）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">蜂蜜</td><td style="border:1px solid #ccc; padding:6px;">羊奶（2:1）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">木头</td><td style="border:1px solid #ccc; padding:6px;">木炭（1:1，仅木头时 3 秒完成）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">各类肉</td><td style="border:1px solid #ccc; padding:6px;">鸟蛋（鸟笼规则，1:1）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">农作物 / 种子</td><td style="border:1px solid #ccc; padding:6px;">对应种子或鸟粪（同鸟笼喂鸟逻辑）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">猪王可收物品</td><td style="border:1px solid #ccc; padding:6px;">金块等（同猪王交易规则）</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">有耐久的工具 / 护甲等</td><td style="border:1px solid #ccc; padding:6px;">耐久归零（无额外产物；整批 8 分钟）</td></tr>
        </table>

        <p><b>其它：</b></p>
        <ul>
            <li>小地图可显示星塔图标</li>
            <li>锤击拆除（工作量 5）会掉落格内物品，并返还部分材料（[[星星碎片]] × 1、电子元件 × 1；紫宝石不返还）</li>
        </ul>
    `,

    "zhei_baibao_farm_god": `
        <p><b>百宝种地的神</b>是万物百宝自带的自动种田助手，长得有点像沃姆伍德。把它部署在[[星塔]]旁边，它就会在圈里自己开荒、播种、收获、照料——<b>不会跟着你跑</b>，一般也不会被怪物追着打。</p>

        <p><b>制作配方：</b>活木 × 3 + 种子 × 5 + 齿轮 × 2</p>
        <p><b>制作科技：</b>炼金引擎（二本）；百宝角色栏（须配合[[星塔]]使用）</p>

        <p><b>怎么让它开工：</b></p>
        <ol>
            <li>先放一座[[星塔]]，圈好干活范围</li>
            <li>在附近部署种地神，稍等它会自动连上星塔；没连上会提醒「请在附近放一个星塔」</li>
            <li>把[[封印之杖]]、[[封印之杖2]]、铲子、水壶、肥料等交给它，或丢在圈里地上让它捡</li>
            <li>在圈里放[[万物百宝]]、[[百宝小型]]或[[白熊冰箱]]，用来存收获；配合[[种地神遥控器]]还能从冰箱里按配比取种</li>
            <li>种子要放进它背包<b>左上九格种子区</b>（见下文），它才会按格播种</li>
        </ol>

        <p><b>圈里会自动做的事：</b></p>
        <ul>
            <li><b>开荒：</b>需要[[封印之杖]]（交给它或放圈里）；有法杖时用开垦法术铺地（3×3 一块）</li>
            <li><b>清杂物：</b>用铲子，或[[封印之杖]]挖掉农场杂物</li>
            <li><b>播种：</b>只种背包<b>左上九格</b>里的种子，九格与地里 3×3 农场地一一对应；空坑对不上种子时会提醒「请按左上九格配比把种子放进种子格」</li>
            <li><b>收获：</b>熟了手摘；巨大作物可敲收；有[[封印之杖]]且圈里待收作物时，会用收集法术一次收一片</li>
            <li><b>照料：</b>对话、浇水、施肥——有[[封印之杖2]]时优先用法术；没有就用水壶、肥料等实物</li>
            <li><b>拾取与存箱：</b>捡圈里掉落；背包满了就把收获存进圈里的百宝或冰箱（你正开着那个箱子时它会请你先关上）</li>
            <li><b>脱困：</b>被针刺旋花缠住会自己打几下挣脱</li>
        </ul>

        <p><b>背包说明（5×5，共 25 格）：</b></p>
        <ul>
            <li><b>左上 3×3（九格）</b>：只能放<b>种子</b>，格底有特殊标记；种地时按这九格的摆法对应地里九块田</li>
            <li><b>其余十六格</b>：只能放<b>收获物等非种子</b>，种子误放这里放不进去</li>
            <li>支持<b>无限堆叠</b>，格内<b>暂停腐烂</b></li>
            <li>打开背包时，下方有<b>手 / 身 / 头</b>装备栏，可给它换法杖、护甲等</li>
            <li>背包上方有<b>「分配」</b>按钮：九格里已有种子时，点一下会把同种种子<b>均分</b>到各个种子格（类似勋章耕地机的一键分配）</li>
            <li>右键给予物品会收进背包；可装备的东西会自动戴到对应部位</li>
        </ul>

        <p><b>法杖怎么配（推荐）：</b></p>
        <ul>
            <li><b>[[封印之杖]]：</b>开荒铺地、批量收集 / 敲收作物</li>
            <li><b>[[封印之杖2]]：</b>范围对话、浇水、施肥；一轮照料完大约冷却 6 秒</li>
            <li>装备法杖后它会<b>真的施法</b>，不是装样子；缺工具或物资时头顶会有语音提示</li>
        </ul>

        <p><b>和[[种地神遥控器]]的配合：</b></p>
        <ul>
            <li>遥控器可让它<b>休息</b>（躺下、停活、回血更快）或<b>开始工作</b></li>
            <li>「种植配比」会读它绑定的星塔圈里冰箱 / 百宝里的种子，列出当前季节能巨大化的摆法（纯种九格、1:1、1:2、1:1:1 等），点选后它会：先把九格种子存回冰箱 → 再按配比从冰箱取种摆满九格 → 然后开种；九格用光且冰箱还有种会继续补</li>
            <li>若九格已经是正确摆法，点配比后会直接开始干活</li>
        </ul>

        <p><b>其它：</b></p>
        <ul>
            <li>生命 <b>300</b>，会慢慢回血；能穿过巨大作物等障碍，不会淹死</li>
            <li>工作范围与[[星塔]]一致，默认 <b>16 码</b>，可在模组配置「百宝种地的神工作半径」里改</li>
            <li>星塔被拆掉后，它会再找附近的星塔；对星塔<b>右键</b>可「解除绑定」</li>
            <li><b>储水：</b>自身储水容量 <b>18000</b>，<b>只能</b>由附近的[[好运池]]自动补充（空槽时开始一轮补水，每次 +1800，约 10 次补满）；有[[封印之杖2]]时优先法术浇水，不耗储水</li>
        </ul>
    `,

    "zhei_wa_remote": `
        <p><b>种地神遥控器</b>是指挥[[百宝种地的神]]的便携道具，外形和操作方式类似薇诺娜的遥控器：拿在手上打开<b>遥控轮盘</b>，点图标即可下指令，不用跑到田里喊。</p>

        <p><b>制作配方：</b>种子 × 5 + 电子元件 × 1 + 金块 × 2</p>
        <p><b>制作科技：</b>炼金引擎（二本）；百宝角色栏</p>

        <p><b>怎么用：</b></p>
        <ol>
            <li>把遥控器拿在手上（或放在物品栏里选中）</li>
            <li>打开遥控轮盘（与薇诺娜遥控器相同的操作）</li>
            <li>点下面三个功能之一</li>
        </ol>

        <p><b>三个功能：</b></p>
        <ul>
            <li><b>休息</b>：让范围内的种地神立刻停下，原地躺下睡觉，不再干活；休息时会<b>回血更快</b>。若它正在整理种子或摆配比，会先收尾再躺。读档后仍处于休息状态的会继续躺着。</li>
            <li><b>开始工作</b>：叫醒正在休息的种地神，继续自动农活。若本来就在干活，会提示「本来就在工作」。</li>
            <li><b>种植配比</b>：打开配比菜单（详见下文）</li>
        </ul>

        <p><b>指挥范围：</b></p>
        <ul>
            <li>「休息」「开始工作」默认只影响<b>离你 48 码以内</b>的种地神</li>
            <li>可在模组配置<b>「种地神遥控器指挥范围」</b>里改成 <b>32 码</b>、<b>全图</b>等</li>
            <li>地图上没有种地神时会提示；都在休息或都在干活时也会有对应提示</li>
        </ul>

        <p><b>种植配比（做巨大作物用）：</b></p>
        <ul>
            <li>会找<b>离你最近、且已连上[[星塔]]</b>的那一位种地神</li>
            <li>扫描它工作圈里[[万物百宝]]、[[百宝小型]]、[[白熊冰箱]]中的<b>种子</b>，按<b>当前季节</b>列出能组成巨大化的方案，例如：
                <ul>
                    <li><b>纯种×9</b>：九格同一种作物</li>
                    <li><b>1:1、1:2、1:1:1</b>：两种或三种作物混种（混种时中间可能故意留空格，属于正常摆法）</li>
                </ul>
            </li>
            <li>点选一行后，种地神会自动：把九格里的种子先存回冰箱 → 再按该行配比从冰箱取种、摆满九格 → 开始种；若九格本来就已经摆对了，会直接开种</li>
            <li>冰箱种子不够、没有连星塔的种地神、或它正在整理种子时，会有文字提示；摆种中途种子对不上配比也会说话提醒你重新选</li>
        </ul>

        <p><b>小贴士：</b></p>
        <ul>
            <li>平时手动种：自己往种地神背包<b>左上九格</b>放种子，或用背包里的<b>「分配」</b>均分</li>
            <li>想省心混种巨大化：种子放圈里冰箱，用遥控器「种植配比」一键摆格</li>
            <li>出门前点「休息」，回来再点「开始工作」，不用拆种地神</li>
        </ul>
    `,

    "zhei_good_luck": `
        <p><b>好运池</b>是可泡澡的星光温泉：夏凉冬暖，回血回 san、解除黑血，还能种水中木、给种地神补水。旁放[[好运石]]后解锁作祟复活与灵药浸泡；泡澡还有概率掉出[[真好运石]]。</p>

        <p><b>制作配方：</b>石砖 × 5 + 黄金铲 × 1 + [[星星碎片]] × 10</p>
        <p><b>制作科技：</b>太阳雕像科技（需要[[太阳雕像仿品]]作为科技站）；百宝结构栏</p>
        <p><b>特殊：</b>永久建筑，<b>不可锤毁</b></p>

        <p><b>泡澡：</b></p>
        <ul>
            <li>最多 <b>4</b> 人同时浸泡；站进池面即可（泡澡半径约 2.8 码）</li>
            <li>默认恢复：约 <b>血 +5/秒</b>、<b>san +2.5/秒</b>（约为帐篷的 2.5 倍）；并按每秒约 <b>1%</b> 解除生命上限惩罚（黑血）</li>
            <li>速率可在模组配置<b>「好运池泡澡回血回san速度」</b>中调节（0.5x～3x，默认 1x）</li>
            <li>泡澡时略增潮湿；获得与骨盔同类的影怪威慑（影怪不会主动攻击）</li>
            <li>体温：旁站冬放热 / 夏吸热（春秋关闭）；泡澡会积攒季节体温 buff，离池后仍可持续（约每泡 1 秒积攒 6 秒，上限约 <b>40 分钟</b>）</li>
        </ul>

        <p><b>水中木：</b></p>
        <ul>
            <li>背起<b>疙瘩树果</b>对池子右键「种植水中木」；每池只能有一棵</li>
            <li>池内水中木支持远距施肥（靠近好运池即可对树操作）</li>
        </ul>

        <p><b>与[[好运石]]联动：</b></p>
        <ul>
            <li>一池仅绑一颗好运石；石须放在池旁环带（距中心约 <b>4.7～5.7</b> 码）</li>
            <li>绑定后：鬼魂对池子<b>作祟即可复活</b>（同重生护符），冷却 <b>1 分钟</b>，无次数限制；可站在池边作祟</li>
            <li>石内三种灵药供泡澡吸取对应 buff（详见好运石词条）；活鱼会在池面游动展示（最多 9 条装饰假鱼）</li>
        </ul>

        <p><b>种地神补水：</b></p>
        <ul>
            <li>放置时可预览绿色补水范围圈（半径固定 <b>32 码</b>）</li>
            <li>范围内[[百宝种地的神]]储水为空时开始自动补水：每次 +1800，直至满（容量 18000）；有水条飞向种地神的特效</li>
            <li>种地神储水的<b>唯一</b>合法来源就是好运池</li>
        </ul>

        <p><b>其它：</b></p>
        <ul>
            <li>可作为水源打水；微弱发光（同原版温泉浴盐后档）</li>
            <li>泡澡掉落[[真好运石]]：每位玩家独立 <b>1%</b>；进池立刻判一次，之后每 <b>30 秒</b>再判；离池不判定</li>
        </ul>
    `,

    "zhei_good_luck_stone": `
        <p><b>好运石</b>是安放在[[好运池]]旁的石匣容器：存灵药供泡澡吸取、存活鱼让池面游动，并让池子获得作祟复活能力。</p>

        <p><b>制作配方：</b>告密的心 × 1 + [[星星碎片]] × 5 + 重生护符 × 2</p>
        <p><b>制作科技：</b>太阳雕像科技（需要[[太阳雕像仿品]]作为科技站）；百宝结构栏</p>

        <p><b>放置与绑定：</b></p>
        <ul>
            <li>只能放在好运池旁环带内（距池中心约 <b>4.7～5.7</b> 码）；已有绑定石的池子不能再放</li>
            <li>放置后自动绑定最近可用的好运池；悬停可看到「已绑定 / 未绑定」</li>
            <li>一池一石；锤毁（工作量 <b>3</b>）会掉出格内物品并按配方返还材料</li>
            <li>有皮肤「好运石·彩纹」</li>
        </ul>

        <p><b>容器（3×4，共 12 格）：</b></p>
        <ul>
            <li>仅可放入：[[烈火杏娇疏灵药]]、[[八角玄冰灵药]]、[[鸡冠凤凰灵药]]，以及带 <code>pondfish</code> / <code>smalloceancreature</code> 标签的活鱼</li>
            <li>[[相思断肠灵药]]不能放入（救人用，不参与浸泡）</li>
            <li>反鲜速率与[[玉食盒]]共用模组配置「玉食盒/好运石反鲜速率」（默认 <b>5%</b>）</li>
        </ul>

        <p><b>泡澡灵药吸取：</b></p>
        <ul>
            <li>池内有人泡澡且石内有对应灵药时，持续吸取并积累同食用效果的 buff：
                <ul>
                    <li>[[烈火杏娇疏灵药]] → 火免抗性</li>
                    <li>[[八角玄冰灵药]] → 极致寒冰</li>
                    <li>[[鸡冠凤凰灵药]] → 熬夜大师</li>
            ...
            <li>消耗规则：约每泡 <b>480 秒</b>（单人）消耗 1 个；多人同泡时消耗加快（速度 × 泡澡人数）</li>
            <li>积攒时长约每泡 1 秒换 6 秒 buff，单次上限约 40 分钟；换药或离池时会结算当前进度</li>
        </ul>

        <p><b>活鱼与复活：</b></p>
        <ul>
            <li>石内存活鱼 → 绑定池的水面出现对应游动装饰（最多 9 条；仅展示，不可捕捞）</li>
            <li>绑定后：作祟好运池可复活（冷却 1 分钟，无次数限制）</li>
        </ul>
    `,

    "zhei_good_luck_stone_z": `
        <p><b>真好运石</b>是可携带的好运结晶，泡澡时从[[好运池]]中随机掉落。随身携带提供幸运、多倍掉落与豆增压式护盾；吸收小偷包或[[紫水晶剑]]可成长。</p>

        <p><b>获取：</b>在好运池泡澡时掉落——每位玩家独立 <b>1%</b>；进池立刻判定一次，之后每 <b>30 秒</b>再判；离池不判定。不可制作。</p>

        <p><b>携带限制：</b>每位玩家身上最多 <b>一颗</b>；已有时再捡会自动丢回地上并提示。</p>

        <p><b>成长（吸收）：</b></p>
        <ul>
            <li>手持真好运石，右键地上或物品栏中的<b>小偷包</b> / <b>[[紫水晶剑]]</b>执行「吸收」</li>
            <li>每次吸收 +1 经验；每级需 <b>25</b> 经验；最高 <b>10</b> 级（1→10 共需吸收 225 次）</li>
            <li>满级后无法再吸收</li>
        </ul>
        ...
        <table style="border-collapse:collapse; width:100%; max-width:640px; margin:8px 0; font-size:0.95em;">
            <tr style="background:#f5f5f5;">
                <td style="border:1px solid #ccc; padding:6px;"><b>等级</b></td>
                <td style="border:1px solid #ccc; padding:6px;"><b>幸运掉落</b></td>
                <td style="border:1px solid #ccc; padding:6px;"><b>Boss/坎普斯/海象掉落</b></td>
                <td style="border:1px solid #ccc; padding:6px;"><b>豆增压护盾</b></td>
            </tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">1</td><td style="border:1px solid #ccc; padding:6px;">+3%</td><td style="border:1px solid #ccc; padding:6px;">×1</td><td style="border:1px solid #ccc; padding:6px;">5%</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">2～4</td><td style="border:1px solid #ccc; padding:6px;">+6%～+12%</td><td style="border:1px solid #ccc; padding:6px;">×2</td><td style="border:1px solid #ccc; padding:6px;">10%～20%</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">5～9</td><td style="border:1px solid #ccc; padding:6px;">+15%～+27%</td><td style="border:1px solid #ccc; padding:6px;">×3</td><td style="border:1px solid #ccc; padding:6px;">25%～45%</td></tr>
            <tr><td style="border:1px solid #ccc; padding:6px;">10</td><td style="border:1px solid #ccc; padding:6px;">+30%</td><td style="border:1px solid #ccc; padding:6px;">×4</td><td style="border:1px solid #ccc; padding:6px;">50%</td></tr>
        </table>
        <ul>
            <li><b>幸运：</b>每级 +3%，满级 30%；作为概率掉落物的判定下限（不走原版双曲线幸运公式）</li>
            <li><b>倍率：</b>只影响「掉几份」；作用于 Boss（epic）、坎普斯、海象等；额外每一轮会重新掷概率</li>
            <li><b>护盾：</b>受击时有概率完全格挡（类似 WX-78 豆增压电路过载护盾），触发时有金色护盾特效</li>
            <li>悬停可查看当前等级 / 经验 / 幸运 / 倍率 / 护盾概率</li>
        </ul>
    `
};
